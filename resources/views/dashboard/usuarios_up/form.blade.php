<form @if($view == "create") wire:submit.prevent="storeUsuario" @endif xmlns:wire="http://www.w3.org/1999/xhtml">
    ...
    <div class="form-group">
        ...
        <div class="input-group mb-3">
            ...
            <span class="input-group-append">
                <button type="button" wire:click="generarClave" class="btn btn-info btn-flat btn-sm text-sm"><i class="fas fa-key"></i></button>
            </span>
            @error('password')
            <span class="col-sm-12 text-sm text-bold text-danger">
                <i class="icon fas fa-exclamation-triangle"></i>
    ...
    <div class="form-group">
        @if($view == "create")
            ...
            @else
            <input type="submit" class="btn btn-block btn-primary" value="">
        @endif
