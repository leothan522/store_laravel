@if($listarCategorias->count() > 0 && is_null($categoria))
<div class="container-fluid">
    <div class="row px-xl-5 pb-3">

        @foreach($listarCategorias as $cat)
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
            <a class="text-decoration-none" onclick="preSubmit()" href="{{ route('android.tienda', [auth()->id(), $cat->id]) }}">
    ...
    @include('web_android.tiendas.informacion')
