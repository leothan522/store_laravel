<div class="col-lg-9 col-md-8">
    <div class="row pb-3">
                ...
                <div class="ml-2">
                    <span class="section-title position-relative mb-3">
                        <span class="bg-secondary pr-3" id="show_estatus">
                            Resultados @if($modulo) para "<strong class="text-danger">{{ $modulo }}</strong>" @endif
                        </span>
                    </span>
                </div>
            </div>
        ...
        <div class="container-fluid text-center">
                    ...
                    <div class="row {{--px-xl-5 pb-3--}}">
                        ...
                        @foreach($listarProductos as $producto)
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 pb-1">
                                <a class="text-decoration-none" onclick="preSubmit()" href="{{ route('android.detalles', [auth()->id(), $stock->id]) }}">
            ...
            @else
                Sin resultados para la busqueda <br> <strong class="text-bold"> { <span class="text-danger">{{ $modulo }}</span> }</strong>
            @endif
