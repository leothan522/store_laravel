<div class="bg-light p-30 mb-5">
    ...
    <div class="border-bottom pt-3 pb-2">
        ...
        {{--@if($pedido->delivery)--}}
        <div class="d-flex justify-content-between mt-3" id="show_delivery">
            <h6>Delivery</h6>
            <h6>
    ...
    <div class="pt-2">
        <div class="d-flex justify-content-between mt-2">
            ...
            <h5 class="text-danger"><strong id="carrito_total">${{--{{ formatoMillares($pedido->total, 2) }}--}}</strong></h5>
        </div>
        <div class="d-flex justify-content-between mt-2">
            <h5>Bs.</h5>
            <h5>
                <span id="carrito_bs">{{--{{ formatoMillares($pedido->bs, 2) }}--}} Bs.</span>
            </h5>
        </div>
    </div>
</div>
