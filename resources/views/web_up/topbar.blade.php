    ...
    <div class="row bg-secondary py-1 px-xl-5">
        <div class="col-lg-6 d-none d-lg-block">
            <div class="d-inline-flex align-items-center h-100">
                @if(auth()->check())
                    <a class="text-dark btn btn-link mr-3" href="{{ route('web.perfil') }}" onclick="preSubmit()"><i class="fas fa-envelope"></i> {{ auth()->user()->email }}</a>
                    <a class="text-dark btn-link mr-3" href="{{ route('web.perfil') }}" onclick="preSubmit()"><i class="fas fa-user"></i> {{ auth()->user()->name }}</a>
        ...
        <div class="col-lg-6 text-center text-lg-right">
            ...
            @else
                <a class="text-dark mr-3 btn btn-link" href="{{ route('web.home') }}" onclick="preSubmit()"><i class="fas fa-sign-in-alt"></i> {{ __('Login') }}</a>
                <a class="text-dark mr-3 btn btn-link" href="{{ route('register') }}" onclick="preSubmit()"><i class="fas fa-user-plus"></i> {{ __('Register') }}</a>
            @endif
            ...
            <div class="d-inline-flex align-items-center d-block d-lg-none">
                <a href="{{ route('web.favoritos') }}" class="btn px-0 ml-2" onclick="preSubmit()">
                ...
                <a href="{{ route('web.carrito') }}" class="btn px-0 ml-2" onclick="preSubmit()">
